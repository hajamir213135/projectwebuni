...
<main>
    ...
    <section class="content">
        <p class="paneltitle">مدیریت اخبار</p>
        <a href="./newblog.php"><button type="button" class="btn btn-primary">ایجاد خبر</button></a>
        <div class="infoblogs">
            <table class="table table-bordered">
                ...
                <?php
                    while($b= mysqli_fetch_array($query,MYSQLI_ASSOC)){
                        echo '<tr>';
                        echo '<td>'.$b['title'].'</td>';
                        echo '<td>'.substr($b['decs'],0,150)."...".'</td>';
                        echo '<td>'.$b['date'].'</td>';
                        echo '<td><a href="editblog.php?id='.$b['blogid'].'"><button type="button" class="btn btn-primary">ویرایش</button></a></td>';
                        echo '<td><a href="deleteblog.php?id='.$b['blogid'].'"><button type="button" class="btn btn-primary">حذف</button></a></td>';
                        echo '</tr>';
                    }
                ?>
                </tbody>
